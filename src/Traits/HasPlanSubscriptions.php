...
namespace Webaune\Subscriptions\Traits;
...
trait HasPlanSubscriptions
{
    ...
    {
        return $this->morphMany(config('webaune.subscriptions.models.plan_subscription'), 'subscriber', 'subscriber_type', 'subscriber_id');
    }
     ...
     *
     * @return \Webaune\Subscriptions\Models\PlanSubscription|null
     */
    ...
    public function subscribedPlans(): Collection
    {
        ...
        return app('webaune.subscriptions.plan')->whereIn('id', $planIds)->get();
    }
     ...
     *
     * @return \Webaune\Subscriptions\Models\PlanSubscription
     */
